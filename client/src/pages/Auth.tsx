  ...
  return (
    <main className="grid min-h-screen bg-background lg:grid-cols-[1.05fr_.95fr]">
      <section className="relative hidden overflow-hidden bg-[#103f3a] p-10 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3"><div className="grid h-11 w-11 place-items-center rounded-2xl bg-[#f5c96a] font-display font-bold text-[#123f39]">RP</div><div><div className="font-display text-xl font-bold">RentPulse</div><div className="text-[10px] uppercase tracking-[.2em] text-teal-100/70">Landlord operations</div></div></div>
