      ...
      <div className="flex h-full min-h-[calc(100dvh-2.5rem)] flex-col">
        <div className="flex items-center justify-between px-3">
          <Link href="/" className="flex items-center gap-3" onClick={() => setMobileOpen(false)}>
            <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#0d625a] p-1.5 shadow-[0_8px_16px_rgba(13,98,90,.18)]"><img src="/manus-storage/rentpulse-mark_ba941ccb.png" alt="RentPulse logo" className="h-full w-full object-contain" /></div>
